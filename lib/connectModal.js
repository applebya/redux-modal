...
var INITIAL_MODAL_STATE = (0, _immutable.Map)();
  ...
  return function(WrappedComponent) {
    var ConnectModal = (function(_Component) {
      ...
      function ConnectModal(props, context) {
        ...
        _this.state = { show: props.modal.get("show") };
        return _this;
      }
      ...
      _createClass(ConnectModal, [
        {
          ...
          value: function componentWillReceiveProps(nextProps) {
            ...
            if ((0, _utils.isUndefined)(modal.get("show"))) {
              return this.unmount();
            }
        ...
        },
        {
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              WrappedComponent,
              _extends({}, ownProps, modal.get("props"), {
                show: show,
